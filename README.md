...
- 用户使用CDN缓存资源的过程：
    ...
    8. 如果缓存服务器没有用户想要的内容，那么缓存服务器就会向它的上一级缓存服务器请求内容，以此类推，知道获取到需要的资源。如果最后还是没有，就会进行回源，到自己的服务器中获取资源，然后把它们缓存到CDN服务器上。
...
### CDN刷新和预热
CDN提供资源的刷新的预热功能。<font color="	#FF6347">通过刷新功能，可以强制CDN节点`回源`并获取最新文件；通过预热；通过预热，可以在业务高峰期预热热门资源，提高资源的访问效率。</font>
